...
# returns a list of actors' names. It will be run on the
# file flying_circus_cast.txt (this information was collected from imdb.com).
# Each line of that file consists of an actor's name, a comma, and then
# some (messy) information about roles they played in the programme. You'll
# need to extract only the name and add it to a list. You might use the .split()
